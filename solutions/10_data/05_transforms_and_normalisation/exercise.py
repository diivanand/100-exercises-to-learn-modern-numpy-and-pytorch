# Solution -- 10.05 Transforms and normalisation
import torch
...
def prepare(
    ...
    # The validation split stands in for data the model will meet later. Its
    # values must not influence anything, including the preprocessing; if
    # they did, the validation score would be measured on a pipeline that had
